...
var OrderPanelPage = /** @class */ (function () {
    ...
    OrderPanelPage.prototype.LoadSavedOrders = function () {
        var _this = this;
        this.transactionProvide.GetOrders(function (Orders) {
            if (Orders.IsSucess) {
                _this.Orders = Orders.data.Header;
            }
            else {
                _this.presentConfirm(Orders.Message);
            }
        });
    };
...
var ProductCategoryAddPage = /** @class */ (function () {
    ...
    ProductCategoryAddPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-product-category-add',template:/*ion-inline-start:"D:\app\StrudioApp\SIMPLEPOS\src\pages\product-category-add\product-category-add.html"*/'<!--\n\n  Generated template for the ProductAddPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  \n\n    <ion-navbar>\n\n        <button ion-button end navPop >\n\n            <ion-icon  name="close"></ion-icon>\n\n          </button>\n\n      <ion-title>Category</ion-title>\n\n      \n\n    </ion-navbar>\n\n  \n\n  </ion-header>\n\n  \n\n  \n\n  <ion-content padding>\n\n    <ion-grid>\n\n      <ion-row>\n\n        <ion-col>\n\n            <ion-list>\n\n                <ion-item>\n\n                  <ion-label>Category Name</ion-label>\n\n                  <ion-input [(ngModel)]="productDTO.Name" type="text"></ion-input>\n\n                </ion-item>     \n\n              </ion-list>\n\n              \n\n        </ion-col>\n\n        <ion-col col-4  >\n\n            <ion-searchbar (ionInput)="getItems($event)"></ion-searchbar>\n\n            <ion-list style="height:30vh; overflow:auto">\n\n              <ion-item *ngFor="let item of productfilter" (click)="selectItem(item)">\n\n                {{ item.Name }}\n\n              </ion-item>\n\n             \n\n            </ion-list>\n\n        </ion-col>\n\n      </ion-row>\n\n    </ion-grid>\n\n   \n\n  \n\n    <button ion-button (click)="newCategory()" >New</button>\n\n    <button ion-button (click)="createCategory()" >Save</button>\n\n    <button ion-button (click)="deleteCategory()" >Delete</button>\n\n  </ion-content>'/*ion-inline-end:"D:\app\StrudioApp\SIMPLEPOS\src\pages\product-category-add\product-category-add.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__angular_http__["b" /* Http */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */], __WEBPACK_IMPORTED_MODULE_4__providers_transaction_provide_transaction_provide__["a" /* TransactionProvideProvider */]])
...
var ListPage = /** @class */ (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"D:\app\StrudioApp\SIMPLEPOS\src\pages\list\list.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>List</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <ion-list>\n\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n\n      {{item.title}}\n\n      <div class="item-note" item-end>\n\n        {{item.note}}\n\n      </div>\n\n    </button>\n\n  </ion-list>\n\n  <div *ngIf="selectedItem" padding>\n\n    You navigated here from <b>{{selectedItem.title}}</b>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"D:\app\StrudioApp\SIMPLEPOS\src\pages\list\list.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */]])
    ], ListPage);
    return ListPage;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"D:\app\StrudioApp\SIMPLEPOS\src\app\app.html"*/'<ion-menu [content]="content">\n\n  <ion-header>\n\n    <ion-toolbar>\n\n      <ion-title>Menu</ion-title>\n\n    </ion-toolbar>\n\n  </ion-header>\n\n\n\n  <ion-content>\n\n    <ion-list>\n\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n\n        {{p.title}}\n\n      </button>\n\n    </ion-list>\n\n  </ion-content>\n\n\n\n</ion-menu>\n\n\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"D:\app\StrudioApp\SIMPLEPOS\src\app\app.html"*/
        }),
...
var TransactionProvideProvider = /** @class */ (function () {
    ...
    TransactionProvideProvider.prototype.GetOrders = function (callback) {
        this.http.get('http://localhost:4000/api/order').subscribe(function (result) {
            console.log(result);
            callback(JSON.parse(result['_body']));
        });
    };
